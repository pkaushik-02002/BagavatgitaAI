...
import { GitaAILogo } from "@/components/hero-section" // Import GitaAILogo
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      toast.success("Welcome to GitaAI! Your spiritual journey begins now.")
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-amber-200 shadow-lg">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold text-gray-900">Begin your journey</CardTitle>
            <CardDescription className="text-gray-600">
              Create your account to access ancient wisdom through AI
            </CardDescription>
          </CardHeader>
